...
# The goal fo this lab assignment was to learn and practice how to solve
# problems by using linked lists. The task for this assignment was to create
# linked lists with numbers from 0 to 100 and sort the with different. In 
# this case we have to sort them using bubblesort, mergesort, and quicksort
# method   
...
def getMiddle(L):
        ...
        ## Move first by two and second by one 
